...
<body>
 ...
 <style>
    ...
    <div style="max-width: 1300px;
            ...
            background-image: url('assets/img/Customersetup.png');
            background-size: 430px 167px;
            background-repeat: no-repeat; 
            background-position: center;">
            
        <h1 style="font-size: 50px; max-width: 800px;color: #2eca6a;"> Dashboard </h1> <h6 style="color:gray;float:right">(Customer Panel)</h6>
        </div>
        <!-- Notifications Panel -->
        <div style="max-width: 1300px;
    		margin-top: 40px;
        ...
        <div style="
            ...
            <h2 style="margin-bottom: 20px;">Latest Notifications</h2>
            <p class="empty">No new notifications at the moment.</p>
        </div>
